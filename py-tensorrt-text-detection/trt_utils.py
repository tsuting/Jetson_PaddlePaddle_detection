...
class TRTUtils:
    ...
    def _build_engine_onnx(self)->trt.tensorrt.ICudaEngine:
        ...
        with trt.Builder(TRT_LOGGER) as builder, builder.create_network(EXPLICIT_BATCH) as network, \
            ...
            print('Building an engine from file {}; this may take a while...'.format(self._original_model_path))
    ...
    def inference_single(self, input_data:np.ndarray, profile_idx:int=0, profiling:bool=False)->List:
        """
        ...
        binding_shape = list(self._trt_engine.get_binding_shape(index=input_binding_idx))
        ...
        self._trt_context.execute_async_v2(bindings=bindings, stream_handle=stream.handle)
